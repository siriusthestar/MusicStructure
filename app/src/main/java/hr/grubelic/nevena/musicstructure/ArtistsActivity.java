...
public class ArtistsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the content of the activity to use the activity_artists.xml layout file
        setContentView(R.layout.activity_artists);

        // Find Button by id and set selected button style on it
        ((Button)findViewById(R.id.artists)).setTextAppearance(this, R.style.SelectedButton);
        ...
        playing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent searchIntent = new Intent(ArtistsActivity.this, PlayingActivity.class);
                startActivity(searchIntent);
            }
        });
        ...
        store.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent storeIntent = new Intent(ArtistsActivity.this, StoreActivity.class);
