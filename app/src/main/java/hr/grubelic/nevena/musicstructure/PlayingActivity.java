...
public class PlayingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the content of the activity to use the activity_playing.xml layout file
        setContentView(R.layout.activity_playing);

        // Find Button by id and set selected button style on it
        ((Button)findViewById(R.id.playing)).setTextAppearance(this, R.style.SelectedButton);
        ...
        playing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent searchIntent = new Intent(PlayingActivity.this, PlayingActivity.class);
                startActivity(searchIntent);
            }
        });
