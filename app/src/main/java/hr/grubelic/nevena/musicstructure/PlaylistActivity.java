...
public class PlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.playlist)).setTextAppearance(this, R.style.SelectedButton);
        ...
        playing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent searchIntent = new Intent(PlaylistActivity.this, PlayingActivity.class);
                startActivity(searchIntent);
            }
        });
        ...
        artists.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent artistsIntent = new Intent(PlaylistActivity.this, ArtistsActivity.class);
        ...
        store.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent storeIntent = new Intent(PlaylistActivity.this, StoreActivity.class);
