...
public class AlbumsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.albums)).setTextAppearance(this, R.style.SelectedButton);
        ...
        playing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent searchIntent = new Intent(AlbumsActivity.this, PlayingActivity.class);
                startActivity(searchIntent);
            }
        });
        ...
        store.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent storeIntent = new Intent(AlbumsActivity.this, StoreActivity.class);
